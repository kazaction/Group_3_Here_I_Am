...
def update_user(user_id):
    ...
    if authenticated_user_id != user_id:
        return jsonify({"error": "Forbidden - you can only update your own data"}), 403
...
def check_password(user_id):
    ...
    if authenticated_user_id != user_id:
        return jsonify({"error": "Forbidden - you can only check your own password"}), 403
...
def update_password(user_id):
    ...
    if authenticated_user_id != user_id:
        return jsonify({"error": "Forbidden - you can only update your own password"}), 403
...
def upload_profile_picture(user_id):
    ...
    if authenticated_user_id != user_id:
        return jsonify({"error": "Forbidden - you can only upload your own profile picture"}), 403
